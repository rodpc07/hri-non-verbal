...
moveit::planning_interface::MoveGroupInterface::Plan exagerateTrajectory(moveit::planning_interface::MoveGroupInterface::Plan plan, Eigen::Vector3d xyz, moveit::planning_interface::MoveGroupInterface &move_group_interface)
{
    ...
    bounding_region.dimensions[0] = 0.3;
...
int main(int argc, char **argv)
{
    ...
    moveit::planning_interface::MoveGroupInterface::Plan modified_plan = exagerateTrajectory(my_plan, xyz, move_group_interface);
    ...
    do
    {
        ...
        case 4:
            ...
            modified_plan = exagerateTrajectory(my_plan, xyz, move_group_interface);
            break;
        case 5:
            cout << "X Y Z:";
            cin >> str1 >> str2 >> str3;
